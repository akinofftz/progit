...
Wenn Du ein grafischen Tool zur Bereinigung benutzen willst, dann verwende `git mergetool`, das ein passendes grafisches 'merge'-Tool startet und Dich durch die Konfliktbereiche führt:
